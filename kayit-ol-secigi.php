...
<div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">Kayıt Olma seçiğini</h1>
            <div class="custom-breadcrumbs">
              <a href="#">Ana Sayfa</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong>Kayıt Olma seçiğini</strong></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div>
            <h2><center> Hangi hesap oluşturmak istersiniz? </center></h2>
        </div>
        <div class="row mb-5">
          <div class="col-lg-12">
            <div class="kayitsecme">
                <form class="p-4 p-md-5 border rounded" method="post">
                    <div class="ml-auto">
                        <a href="login.php" class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span></span>Kullanıcı(Menti)</a>
                        <a href="mentor-kayit-ol.php" class="btn btn-outline-white border-width-2 d-none d-lg-inline-block"><span></span>Mentor</a>
