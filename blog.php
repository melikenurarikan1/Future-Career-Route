        ...
        <div class="row align-items-center">
          ...
          <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div class="ml-auto">
              ...
              <a href="kayit-ol-secigi.php" class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span class="mr-2 icon-add"></span>Giriş Yap</a>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6 col-lg-4 mb-5">
            ...
            <h3><a href="blog-single.php" class="text-black">Turizm</a></h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            ...
            <h3><a href="blog-single.php" class="text-black">Coğrafya</a></h3>
            <div>April 15, 2019 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.php"><img src="images/sq_img_4.jpg" alt="Image" class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.php" class="text-black">Mimarlık</a></h3>
            <div>April 15, 2019 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            ...
            <h3><a href="blog-single.php" class="text-black">Bilgisayar Mühendisliği</a></h3>
            <div>April 15, 2019 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
        </div>
